...
public class AddRecordDialog extends JDialog implements ActionListener {
	...
	public Container dialogPane() {
		...
		empDetails.add(genderCombo = new JComboBox<String>( this.parent.gender.toArray(new String[0])), "growx, pushx, wrap");

		empDetails.add(new JLabel("Department:"), "growx, pushx");
		empDetails.add(departmentCombo = new JComboBox<String>(this.parent.department.toArray(new String[0])), "growx, pushx, wrap");
		...
		idField.setText(Integer.toString(this.parent.er.getNextFreeId()));
		return empDetails;
	}
	...
	public void addRecord() {
		...
		this.parent.er.addRecord(theEmployee);
	...
	public boolean checkInput() {
		...
		if (this.parent.er.correctPps(this.ppsField.getText().trim())) {
			ppsField.setBackground(new Color(255, 150, 150));
			valid = false;
		}// end if
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (e.getSource() == save) {
			...
			if (checkInput()) {
				...
				this.parent.fm.changesMade = true;
			}// end if
